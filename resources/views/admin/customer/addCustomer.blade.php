...
<form method="POST" action="/customers"> @csrf
    <div class="card sl-content-card cm-field-container">
        <div class="card-header sl-card-header">
            <h3 class="d-inline">Add Customer </h3>
        ...
        <div class="card-body cm-fields">
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="text" name="name" id="add-customer-name" class="form-control {{ $errors->has('name') ? ' is-invalid-data' : '' }}" value="{{ old('name') }}"> 
					@if($errors->has('name'))
				...
				<div class="form-group col-md-3">
					...
					<input type="text" name="age" id="add-age" class="form-control {{ $errors->has('age') ? ' is-invalid-data' : '' }}" value="{{ old('age') }}"> 
					@if($errors->has('age'))
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control sl-form-control" id="add-gender" name="gender" value="{{ old('gender') }}">
            ...
            <div class="form-row">
				<div class="form-group col-md-8">
					...
					<input type="text" name="email" id="add-email" class="form-control {{ $errors->has('email') ? ' is-invalid-data' : '' }}" value="{{ old('email') }}"> 
					@if($errors->has('email'))
				...
				<div class="form-group col-md-4">
					...
					<input type="text" name="mobile" id="add-mobile" class="form-control {{ $errors->has('mobile') ? ' is-invalid-data' : '' }}" value="{{ old('mobile') }}"> 
